...
- `articles/` — хаб index + 21 статья. Три группы: разборы цен, «как это устроено»
  и кластер «ремесло и вопросы о съёмке» (21.09: звук, свет, вертикаль, подготовка
  к съёмке, как проходит съёмка, что спросить у видеографа, сколько занимает монтаж,
  монтаж с нуля). Оболочка новой статьи берётся из живой соседней страницы скриптом.
