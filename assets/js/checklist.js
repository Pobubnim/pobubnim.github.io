...
(function () {
  ...
  function render() {
    ...
    h.push('<p class="doc-note">Отраслевого норматива «сколько батарей на смену» не существует: расход зависит от камеры, мороза и режима. Собрано конструктором pobubnim.github.io.</p>');
