...
(function () {
  ...
  function render() {
    ...
    h.push("<h2>СОГЛАСИЕ НА СЪЁМКУ И ИСПОЛЬЗОВАНИЕ ИЗОБРАЖЕНИЯ<br>(МОДЕЛЬНЫЙ РЕЛИЗ)</h2>");
    ...
    h.push("<h3>1. Предмет согласия</h3>");
    ...
    h.push("<h3>2. Объём использования</h3>");
