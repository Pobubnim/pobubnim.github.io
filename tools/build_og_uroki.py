...
UROKI = {
    ...
    "tri-oshibki-cveta": (
        "Три ошибки цвета, которые выдают новичка", "Урок 13 · Цвет · живая доска",
        "ЧИСТЫЙ КАДР · ПРИБОРЫ ИЗ ПИКСЕЛЕЙ",
        [("УГОЛ КОЖИ", "127° (+4° к канону)"), ("КОЖА", "63,3 IRE"),
         ("СЕРАЯ КАРТА", "40,8 IRE, R−B +0"), ("ВЕРДИКТ", "кожа на месте")]),
    "svet-iz-okna": (
        "Свет из окна: киношная картинка бесплатно", "Урок 14 · Свет · живая доска",
        "ОКНО 1,5 М · ГЕРОЙ В 1,2 М · ПОВОРОТ 45°",
        [("УГОЛ ОКНА", "64°"), ("ПЕРЕПАД ПО ЛИЦУ", "0,26 ст."),
         ("КОНТРАСТ ЛИЦА", "1,39 ст."), ("ФОН ТЕМНЕЕ", "1,89 ст.")]),
    "raw-ili-log": (
        "RAW или log: что выбрать и в чём разница", "Урок 15 · Цвет · живая доска",
        "S-LOG3, 10 БИТ",
        [("КОДОВ НА СТУПЕНЬ У СЕРОГО", "76"), ("КОДОВ НА ТЕНЬ −5 СТ.", "38"),
         ("ЗАПАС НАД СЕРЫМ", "+6,5 ст."), ("ЦВЕТ ПОСЛЕ ПРАВКИ ББ", "промах 4,3 %")]),
}
