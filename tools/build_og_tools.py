...
TOOLS = {
    ...
    "modelnyj-reliz": ("Модельный релиз", "Документы · согласие",
                       "СОГЛАСИЕ (РЕЛИЗ)", ["1. Разрешаю съёмку", "2. Объём использования",
                                            "ст. 152.1 ГК РФ"]),
    "dogovor-arendy-tehniki": ("Договор аренды техники", "Документы · аренда",
                               "ДОГОВОР АРЕНДЫ ОБОРУДОВАНИЯ", ["1. Опись: серийные номера", "2. Срок, смены, залог",
                                                              "гл. 34 ГК РФ"]),
    ...
    "kalkulyator-nd-filtra": ("Калькулятор ND-фильтра", "Съёмка · свет",
                              "НУЖНО ND", ["Шаттер 1/50, f/2,8, ISO 800", "Яркое солнце · EV 15",
                                           "9,4 стопа → ND500"]),
    "pribory-onlajn": ("Приборы: waveform, вектроскоп", "Цвет · приборы",
                       "КАДР В ЦИФРАХ", ["Серая карта 18% → 41 IRE", "Кожа на линии 123°",
                                         "Клип 0,00% · Rec.709"]),
